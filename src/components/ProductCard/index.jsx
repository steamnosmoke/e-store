  ...
  return (
    <>
      <section className={s.card}>
        <button className={s.favorite} onClick={() => console.log("fav")}>
          <svg
            width='32.000000'
            height='32.000000'
            viewBox='0 0 32 32'
        ...
        <div className={s.inner} onClick={() => console.log("iiner")}>
          <img className={s.picture} src={card} alt='product image' />
          <div className={s.info}>
            <h3 className={s.title}>
              {product.product.name}
            </h3>
            <p className={s.price}>{product.product.price}$</p>
          </div>
